...
public class Realm_test {
	...
	private static Logger logger = LoggerFactory.getLogger(Realm_test.class);
	...
	public static void main(String[] args) {
		...
		Factory<org.apache.shiro.mgt.SecurityManager> factory = new IniSecurityManagerFactory("classpath:shiro_2.ini");
