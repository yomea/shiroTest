...
public class PermissionOption_3 {
	...
	public void test() {
		...
		if (!currentUser.isPermitted("user.delete")) {// 区别user:delete
	...
	@RequiresRoles("boss")
	private void test1() {
		System.out.println("hahahahhahahahahhahahahhahahahahahahahahahhahaha");
	}
